...
#'
#'@details
#' Modify a [qgraph::qgraph] object generated by [semPlot::semPaths] and
#' change the
#' labels of
#' selected nodes.
#'
#' \code{change_node_label2()} is an experimental version that takes a named
#' list as input.
#.
#'
#'@return
#' A [qgraph::qgraph] based on the original one, with node attributes of
#' selected
#'    nodes modified.
#'
...
#'                    \code{node}, is a character denoting the label to be
#'                    changed.
#'                    It should be as appeared in the qgraph. The second part,
#'                    \code{to}, is the new label. Expression can be used in
#'                    \code{to}.
...
#'                  than this string will have the same font size, while
