...
#'
#'@details Modified a qgraph object generated by semPaths and rotate the
#'          residuals of selected edges. Currently supports "ram" and similar
#'          format only.
#'
#'@return
...
#'@param rotate_resid_list A list of named lists. Each named list should have
#'                    two named values: node and rotate. The position of the
#'                    residual of \code{node} will be placed at \code{rotate},
#'                    in degree. The 12 o'clock position is zero degree.
#'                    Positive degree denotes clockwise rotation, and negative
#'                    degree denotes anticlockwise rotation. Alternatively, it
#'                    can be a named vector, with `rotate` as the value and
#'                    `node` as the name of this value.
#'
#'@examples
#'mod_pa <-
#'  'x1 ~~ x2
