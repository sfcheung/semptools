#'@title Set the positions of factors and other aspects of a SEM graph with latent varialbes by semPaths
#'
#'@description Set the positions of factors and other aspects of a SEM graph with latent varialbes by semPaths.
#'
...
#'@param factor_layout A matrix of arbirary size. This matrix will serve as a grid for 
...
set_sem_position <- function(semPaths_plot, 
