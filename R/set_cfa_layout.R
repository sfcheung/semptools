...
#'
#'@description Configure the layout of factors and adjust other aspects of a
#'             CFA graph by semPaths.
#'
#'@details Modified a [qgraph::qgraph] object generated by semPaths based on a
...
#' modified.
#'
#'@param semPaths_plot A [qgraph::qgraph] object generated by semPaths, or
#' a similar qgraph object modified by other [semptools] functions.
#'@param indicator_order A string vector of the indicators. The order of the
#'                       names is the order of the indicators in the graph,
#'                       when they are drawn on the bottom of the graph. The
#'                       indicators should be grouped by the factors on which
#'                       they load on.
...
#'                       c("f2", "f2", "f2", "f1", "f1", "f1").
#'@param fcov_curve A number used to set the curvature of the inter-factor
#'                  covariances. Default is .4.
#'@param loading_position The positions of all factor loadings. Default is .5,
#'                         on the middle of the arrows.
#'                        Larger the number, closer the loadings to the
#'                        indicators. Smaller the number,
#'                        closer the loadings to the factors.
#'@param point_to Can be "down", "left", "up", or "right". Specify the
#'                direction that the factors
