#'@title Set the positions of factors and other aspects of a CFA graph by semPaths
#'
#'@description Set the positions of factors and other aspects of a CFA graph by semPaths.
#'
...
#'@param fcov_curve A number used to set the curvature of the interfactor covariances. Default is .4.
#'@param loading_position The positions of all factor loadings. Default is .5, on the middle of the arrows.
#'                        Larger the number, closer the laodings to the indicators. Smaller the number,
...
#'                       "f4",  "f4",  "f4",  "f3",  "f3",  "f3")
#'p2 <- set_cfa_position(p, indicator_order, 
#'                          indicator_factor, 
#'                          fcov_curve = 1.5, 
#'                          loading_position = .8)
#'plot(p2)
...
set_cfa_position <- function(semPaths_plot, 
