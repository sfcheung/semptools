...
#'
#'@return
#' A qgrpah based on the original one, with various aspects of the model
#' modified.
#'
#'@param semPaths_plot A qgraph object generated by semPaths, or a similar
#'                      qgrpah
...
#'@param indicator_push (Optional) This argument is used to adjust the position
#'                      of
#'                      indicators of selected latent factors. It must be a
#'                      list of lists,
#'                      Each sublist has two named elements: node, the name of
#'                      a latent
#'                      factor, and push, how the positions of its indicators
#'                      will be
#'                      adjusted. If push = 1, there is no change. Larger than
#'                      one,
#'                      the indicators will be "pushed" away from the latent
#'                      factors.
#'                      Less than one, the indicators will be "pulled" to the
#'                      latent
#'                      factors. This argument can also be set by supplying a
#'                      named vector,
#'                      with the values being "push" values, and names being
#'                      the nodes to be
#'                      affected.
...
#'                      Each sublist has two named elements: node, the name of
#'                      a latent
#'                      factor, and spread, how the distance between indicators
#'                      will be
#'                      adjusted. If spread = 1, there is no change. Larger than
#'                      one,
#'                      the indicators will be "spread" away from each other.
#'                      Less than one, the indicators will be placed closer to
#'                      each
#'                      others.  This argument can also be set by supplying a
#'                      named vector,
#'                      with the values being "spread" values, and names being
#'                      the nodes to be
#'                      affected.
#'@param loading_position Default is .5. This is used adjust the position of
#'                        the loadings.
...
#'                  This argument also accepts a list of lists, allowing users
#'                  to
#'                  specify the positions of loadings for each factor
#'                  separately.
#'                  Each sublist will have two named elements: node, the name
#'                  of the 
#'                  latent factor, and position, the positions of all loadings
#'                  of this 
#'                  factors. The values of these positions are used in the same
#'                  way as 
#'                  specifying one single number.  This argument can also be
#'                  set by 
#'                  supplying a named vector, with the values being "position"
#'                  values, 
