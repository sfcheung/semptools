...
#' based on an SEM model with latent factors. Currently only support a
#' model in which all exogenous variables are latent factors, and all
#' observed variables are indicators. If a variable has only one
#' indicator, it is easier to
