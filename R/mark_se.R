...
#'   estimates (edge labels) in a [qgraph::qgraph] object.
#'
...
#'
#' @return
#'  If the input is a [qgraph::qgraph] object, the function returns a qgraph
#'  based on the
#'  original one, with standard error estimates appended. If the input is a list
#'  of qgraph objects, the function returns a list of the same length.
#'
#' @param semPaths_plot A qgraph object generated by
#'   \code{\link[semPlot]{semPaths}}, or a similar qgraph object modified by
